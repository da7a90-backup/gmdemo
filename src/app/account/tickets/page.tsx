        ...
        <div className="mt-4 grid gap-5 lg:grid-cols-12 lg:gap-6">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-2.5 text-[14px] text-ink-2 font-serif">
              {mult > 1
                ? <>Your membership multiplies every bundle — pay for one ticket, <strong className="text-ink">{mult} go in the drum</strong>. No code needed.</>
                : <>Member entries are added automatically at checkout.</>}
            </p>
