...
export const CONTENT_FIELDS: ContentField[] = [
  ...
  { key: "tickets.redirecting", page: "Tickets page", group: "Buy box", label: "Redirect overlay", def: "Redirecting to secure checkout…" },
  { key: "tickets.poweredBy", page: "Tickets page", group: "Buy box", label: "Redirect subtitle", def: "Powered by Shopify" },
  { key: "tickets.drawnLivePrefix", page: "Tickets page", group: "Buy box", label: "Draw-date prefix (before weekday)", def: "Drawn live ·" },
  { key: "tickets.mostPicked", page: "Tickets page", group: "Buy box", label: "Most-picked badge", def: "★ Most picked" },
  { key: "tickets.unitSingular", page: "Tickets page", group: "Buy box", label: "Ticket unit (singular)", def: "ticket" },
  { key: "tickets.unitPlural", page: "Tickets page", group: "Buy box", label: "Ticket unit (plural)", def: "tickets" },
  { key: "tickets.bestValue", page: "Tickets page", group: "Buy box", label: "Best-value badge", def: "★ Best value" },
  ...
  { key: "tickets.charity.statsNote", page: "Tickets — charity & trust", group: "Charity stats", label: "Stats note", def: "all 501(c)(3) cycles" },
  { key: "tickets.charity.donated", page: "Tickets — charity & trust", group: "Charity stats", label: "Donated label", def: "Donated to partner charities" },
  { key: "tickets.charity.k.cycles", page: "Tickets — charity & trust", group: "Charity stats", label: "Stat — cycles", def: "Cycles run" },
  { key: "tickets.charity.k.charities", page: "Tickets — charity & trust", group: "Charity stats", label: "Stat — charities", def: "Charities funded" },
  { key: "tickets.charity.k.cars", page: "Tickets — charity & trust", group: "Charity stats", label: "Stat — cars", def: "Cars given away" },
  { key: "tickets.charity.k.entries", page: "Tickets — charity & trust", group: "Charity stats", label: "Stat — entries", def: "Entries verified" },
  { key: "tickets.trust1.title", page: "Tickets — charity & trust", group: "Trust band", label: "Trust 1 — title", def: "Drawn live" },
  { key: "tickets.trust1.body", page: "Tickets — charity & trust", group: "Trust band", label: "Trust 1 — body", def: "Facebook Live, archived to YouTube." },
  { key: "tickets.trust2.title", page: "Tickets — charity & trust", group: "Trust band", label: "Trust 2 — title", def: "Real paper drum" },
  { key: "tickets.trust2.body", page: "Tickets — charity & trust", group: "Trust band", label: "Trust 2 — body", def: "Every entry is printed and drawn from a physical drum." },
  { key: "tickets.trust3.title", page: "Tickets — charity & trust", group: "Trust band", label: "Trust 3 — title", def: "10% to charity" },
  { key: "tickets.trust3.body", page: "Tickets — charity & trust", group: "Trust band", label: "Trust 3 — body ({cycle}, {charity})", def: "Cycle {cycle}: {charity}." },
  ...
  { key: "mem.math.i2", page: "Membership", group: "Math strip", label: "Item 2", def: "Auto-entered every cycle" },
  { key: "mem.math.i3", page: "Membership", group: "Math strip", label: "Item 3", def: "Cancel any time" },
  ...
  /* -------------------------------- Lookup ------------------------------- */
  { key: "lookup.eyebrow", page: "Lookup", group: "Header", label: "Eyebrow", def: "My entries · ticket lookup" },
  { key: "lookup.h.pre", page: "Lookup", group: "Header", label: "Heading — before accent", def: "Find" },
  { key: "lookup.h.accent", page: "Lookup", group: "Header", label: "Heading — italic accent", def: "your" },
  { key: "lookup.h.post", page: "Lookup", group: "Header", label: "Heading — after accent", def: "tickets." },
  { key: "lookup.intro", page: "Lookup", group: "Header", label: "Intro", long: true, def: "Enter the email or phone you used at checkout. We'll pull your active entries and every past cycle you joined." },
  { key: "lookup.tab.email", page: "Lookup", group: "Form", label: "Email tab", def: "Email" },
  { key: "lookup.tab.phone", page: "Lookup", group: "Form", label: "Phone tab", def: "Phone" },
  { key: "lookup.ph.email", page: "Lookup", group: "Form", label: "Email placeholder", def: "you@example.com" },
  { key: "lookup.ph.phone", page: "Lookup", group: "Form", label: "Phone placeholder", def: "(555) 010-1234" },
  { key: "lookup.find", page: "Lookup", group: "Form", label: "Find button", def: "Find" },
  { key: "lookup.tryDemo", page: "Lookup", group: "Form", label: "Demo link", def: "try the demo account" },
  { key: "lookup.empty", page: "Lookup", group: "States", label: "Pre-search prompt", long: true, def: "Search above to see your entries. The demo account has 2 active draws + 3 past cycles." },
  { key: "lookup.noneTitle", page: "Lookup", group: "States", label: "No-results title", def: "No tickets found." },
  { key: "lookup.noneBody", page: "Lookup", group: "States", label: "No-results body", long: true, def: "Double-check the spelling. If you used a different email or phone, try that one." },
  { key: "lookup.tryDemoBtn", page: "Lookup", group: "States", label: "No-results demo button", def: "Try the demo account" },
  { key: "lookup.welcome", page: "Lookup", group: "Record", label: "Welcome eyebrow", def: "Welcome back" },
  { key: "lookup.stat.active", page: "Lookup", group: "Record", label: "Stat — active", def: "Active" },
  { key: "lookup.stat.past", page: "Lookup", group: "Record", label: "Stat — past", def: "Past" },
  { key: "lookup.stat.tickets", page: "Lookup", group: "Record", label: "Stat — tickets", def: "Tickets" },
  { key: "lookup.active.h", page: "Lookup", group: "Record", label: "Active section heading", def: "Active in current draws" },
  { key: "lookup.active.badge", page: "Lookup", group: "Record", label: "Active section badge", def: "In the drum on draw day" },
  { key: "lookup.active.note", page: "Lookup", group: "Record", label: "Active section note", def: "Your tickets are printed and loaded into the drum on draw day." },
  { key: "lookup.active.none", page: "Lookup", group: "Record", label: "No active entries", def: "No active entries." },
  { key: "lookup.past.h", page: "Lookup", group: "Record", label: "Past section heading", def: "Past entries" },
  { key: "lookup.th.cycle", page: "Lookup", group: "Table", label: "Header — cycle", def: "Cycle" },
  { key: "lookup.th.vehicle", page: "Lookup", group: "Table", label: "Header — vehicle", def: "Vehicle" },
  { key: "lookup.th.tickets", page: "Lookup", group: "Table", label: "Header — tickets", def: "Tickets" },
  { key: "lookup.th.drawn", page: "Lookup", group: "Table", label: "Header — drawn", def: "Drawn" },
  ...
  { key: "lookup.outcome.active", page: "Lookup", group: "Outcome", label: "Active badge", def: "Active" },
  { key: "lookup.cta.title", page: "Lookup", group: "CTA", label: "CTA title", def: "Want to enter the next cycle?" },
  { key: "lookup.cta.sub", page: "Lookup", group: "CTA", label: "CTA subtitle", def: "Cycle 13 just opened — 1969 Mustang Fastback" },

  /* ------------------------------ Thank you ------------------------------ */
  { key: "ty.h.pre", page: "Thank you", group: "Header", label: "Heading — before accent", def: "You're" },
  { key: "ty.h.accent", page: "Thank you", group: "Header", label: "Heading — italic accent", def: "in." },
  { key: "ty.orderPrefix", page: "Thank you", group: "Header", label: "Order badge prefix", def: "Order №" },
  { key: "ty.ticketsBadge", page: "Thank you", group: "Header", label: "Tickets badge suffix (after count)", def: "tickets" },
  { key: "ty.inFor", page: "Thank you", group: "Prize card", label: "“You're in for” tag", def: "You're in for" },
  { key: "ty.prizeLabel", page: "Thank you", group: "Prize card", label: "Prize label", def: "Prize" },
  { key: "ty.printed.pre", page: "Thank you", group: "Printed line", label: "Before the count", def: "We just printed" },
  { key: "ty.printed.post", page: "Thank you", group: "Printed line", label: "After the unit", def: "for the draw." },
  { key: "ty.unitSingular", page: "Thank you", group: "Printed line", label: "Ticket unit (singular)", def: "ticket" },
  { key: "ty.unitPlural", page: "Thank you", group: "Printed line", label: "Ticket unit (plural)", def: "tickets" },
  { key: "ty.pdfBusy", page: "Thank you", group: "Actions", label: "PDF button (generating)", def: "Generating A3 PDF…" },
  { key: "ty.pdfDownload", page: "Thank you", group: "Actions", label: "PDF button (ready)", def: "Download Your Tickets · A3 PDF" },
  { key: "ty.share", page: "Thank you", group: "Actions", label: "Share button", def: "Share" },
  { key: "ty.offer.badge", page: "Thank you", group: "Bonus offer", label: "Offer badge", def: "★ Winner's bonus — this page only" },
  { key: "ty.offer.note", page: "Thank you", group: "Bonus offer", label: "Offer note", def: "Won't be offered again" },
  { key: "ty.offer.title", page: "Thank you", group: "Bonus offer", label: "Offer title (ends before the price)", def: "Add 10 more tickets for" },
  { key: "ty.offer.price", page: "Thank you", group: "Bonus offer", label: "Offer price", def: "$49" },
  { key: "ty.offer.body", page: "Thank you", group: "Bonus offer", label: "Offer body", long: true, def: "51% off the door price — as a thank-you for entering this cycle. Same order, no extra checkout." },
  { key: "ty.offer.claim", page: "Thank you", group: "Bonus offer", label: "Offer button", def: "Claim it" },
  { key: "ty.offer.claimedTitle", page: "Thank you", group: "Bonus offer", label: "Claimed title", def: "10 bonus tickets added." },
  { key: "ty.offer.claimedBody", page: "Thank you", group: "Bonus offer", label: "Claimed body", long: true, def: "They're printing with the rest of your order — watch for the updated ticket list in your email." },
  { key: "ty.ticketsHeading", page: "Thank you", group: "Tickets list", label: "Section heading", def: "Your tickets" },
  { key: "ty.card.note", page: "Thank you", group: "Tickets list", label: "Ticket card note", def: "printed · drum entry" },
  { key: "ty.card.charityPrefix", page: "Thank you", group: "Tickets list", label: "Ticket card charity prefix (before name)", def: "10% →" },
  { key: "ty.moreSuffix", page: "Thank you", group: "Tickets list", label: "Overflow suffix (after +N)", def: "more in the PDF" },
  { key: "ty.receipt.email", page: "Thank you", group: "Receipt", label: "Receipt — email label", def: "Receipt sent to" },
  { key: "ty.receipt.charity", page: "Thank you", group: "Receipt", label: "Receipt — charity label", def: "To charity this purchase" },
  { key: "ty.receipt.draw", page: "Thank you", group: "Receipt", label: "Receipt — draw label", def: "Draw date" },
  { key: "ty.link1.title", page: "Thank you", group: "Next links", label: "Link 1 — title", def: "See all my entries" },
  { key: "ty.link1.sub", page: "Thank you", group: "Next links", label: "Link 1 — subtitle", def: "Lookup by email or phone, anytime" },
  { key: "ty.link2.title", page: "Thank you", group: "Next links", label: "Link 2 — title", def: "Watch the next draw live" },
  { key: "ty.link2.sub", page: "Thank you", group: "Next links", label: "Link 2 — subtitle", def: "Facebook Live + YouTube simulcast" },

  /* ------------------------------- Account ------------------------------- */
  { key: "acc.memberBadgePre", page: "Account", group: "Garage", label: "Member badge prefix", def: "Member ·" },
  { key: "acc.memberBadgeSuffix", page: "Account", group: "Garage", label: "Member badge suffix (after multiplier)", def: "X entries" },
  { key: "acc.h.pre", page: "Account", group: "Garage", label: "Heading — before accent", def: "Your" },
  { key: "acc.h.accent", page: "Account", group: "Garage", label: "Heading — italic accent", def: "garage." },
  { key: "acc.signOut", page: "Account", group: "Garage", label: "Sign-out button", def: "Sign out" },
  { key: "acc.currentGiveaway", page: "Account", group: "Garage", label: "Current-giveaway eyebrow", def: "Current giveaway · drawn live" },
  { key: "acc.memberExclusive", page: "Account", group: "Member offer", label: "Offer eyebrow", def: "Member exclusive" },
  { key: "acc.exclusive.title", page: "Account", group: "Member offer", label: "Offer title ({mult} = multiplier)", def: "{mult}X entries" },
  { key: "acc.exclusive.sub", page: "Account", group: "Member offer", label: "Offer title line 2", def: "on every ticket." },
  { key: "acc.exclusive.body", page: "Account", group: "Member offer", label: "Offer body", long: true, def: "Applied automatically while you're signed in — no code needed. The best deal on the platform." },
  { key: "acc.exclusive.cta", page: "Account", group: "Member offer", label: "Offer button ({mult} = multiplier)", def: "Buy with {mult}X" },
  { key: "acc.active.eyebrow", page: "Account", group: "Active entries", label: "Eyebrow", def: "Check my entries · active" },
  { key: "acc.active.badge", page: "Account", group: "Active entries", label: "Active badge", def: "Active" },
  { key: "acc.ticketsInDrum", page: "Account", group: "Active entries", label: "Tickets suffix (after count)", def: "tickets in the drum" },
  { key: "acc.more", page: "Account", group: "Active entries", label: "Overflow suffix (after +N)", def: "more" },
  { key: "acc.past.eyebrow", page: "Account", group: "Past cycles", label: "Eyebrow", def: "Past cycles" },
  { key: "acc.past.ticketsSuffix", page: "Account", group: "Past cycles", label: "Tickets suffix", def: "tickets" },
  { key: "acc.past.won", page: "Account", group: "Past cycles", label: "Won badge", def: "Won" },
  { key: "acc.past.lost", page: "Account", group: "Past cycles", label: "Didn't-win badge", def: "Didn't win" },
  { key: "acc.tix.back", page: "Account", group: "Member tickets", label: "Back link", def: "Back to your garage" },
  { key: "acc.tix.badge", page: "Account", group: "Member tickets", label: "Pricing badge", def: "★ Member pricing" },
  { key: "acc.tix.blurbPre", page: "Account", group: "Member tickets", label: "Blurb — before the bold count", def: "Your membership multiplies every bundle — pay for one ticket," },
  { key: "acc.tix.blurbStrong", page: "Account", group: "Member tickets", label: "Blurb — bold (after {mult})", def: "go in the drum" },
  { key: "acc.tix.blurbPost", page: "Account", group: "Member tickets", label: "Blurb — after the bold", def: ". No code needed." },
  { key: "acc.tix.blurbSimple", page: "Account", group: "Member tickets", label: "Blurb (no multiplier)", def: "Member entries are added automatically at checkout." },
  { key: "acc.tix.footNote", page: "Account", group: "Member tickets", label: "Footer note ({mult})", def: "Member {mult}X applied to every bundle above · entries land in the drum instantly" },
  { key: "acc.tix.footNoteOff", page: "Account", group: "Member tickets", label: "Footer note (no multiplier)", def: "Member multiplier is currently unavailable — standard entry rates apply." },

  /* ---------------------------- Account — login -------------------------- */
  { key: "acc.login.badge", page: "Account — login", group: "Login", label: "Badge", def: "Member account" },
  { key: "acc.login.h.pre", page: "Account — login", group: "Login", label: "Heading — before accent", def: "Sign" },
  { key: "acc.login.h.accent", page: "Account — login", group: "Login", label: "Heading — italic accent", def: "in." },
  { key: "acc.login.intro", page: "Account — login", group: "Login", label: "Intro", def: "No passwords. We email you a one-time code, you're in." },
  { key: "acc.login.emailLabel", page: "Account — login", group: "Login", label: "Email label", def: "Email" },
  { key: "acc.login.sendCode", page: "Account — login", group: "Login", label: "Send-code button", def: "Email me a code" },
  { key: "acc.login.error", page: "Account — login", group: "Login", label: "Wrong-code error", def: "That code doesn't match — check the demo inbox below." },
  { key: "acc.login.codeSentTo", page: "Account — login", group: "Login", label: "Code-sent label", def: "Code sent to" },
  { key: "acc.login.otpLabel", page: "Account — login", group: "Login", label: "OTP label", def: "6-digit code" },
  { key: "acc.login.verify", page: "Account — login", group: "Login", label: "Verify button", def: "Verify & sign in" },
  { key: "acc.login.differentEmail", page: "Account — login", group: "Login", label: "Change-email link", def: "Use a different email" },
  { key: "acc.login.demoInboxTitle", page: "Account — login", group: "Login", label: "Demo inbox title", def: "Demo inbox — no email is actually sent" },
  { key: "acc.login.demoInboxBody", page: "Account — login", group: "Login", label: "Demo inbox body (before the code)", def: "Your Generous Motors sign-in code is" },
];
