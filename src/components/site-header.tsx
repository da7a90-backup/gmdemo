    ...
    <header className="sticky top-0 z-40 border-b-2 border-ink bg-paper">
      <div className="mx-auto flex h-16 max-w-[1400px] items-center justify-between px-5 gap-6">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/tickets"
            className="hidden md:inline-flex items-center gap-2 bg-accent-bright text-ink px-6 py-2.5 font-condensed uppercase tracking-[0.24em] text-[12px] font-bold border-2 border-ink btn-poly hover:bg-accent hover:text-paper-3 transition-colors"
          >
            Buy tickets · $10
          ...
          <button
            ...
            aria-expanded={open}
            className="md:hidden inline-flex h-11 w-11 items-center justify-center border-2 border-ink bg-paper text-ink"
          >
      ...
      {open && (
        <div className="md:hidden border-t-2 border-ink bg-paper">
          <nav aria-label="Mobile" className="mx-auto max-w-7xl px-5 py-3 flex flex-col divide-y divide-rule-soft">
            ...
            <Link href="/tickets" onClick={() => setOpen(false)} className="mt-2 inline-flex items-center justify-center bg-accent-bright px-5 py-3 border-2 border-ink text-ink font-condensed uppercase tracking-[0.24em] text-[12px] font-bold btn-poly">
              Buy tickets · $10
            </Link>
          </nav>
        </div>
